...
const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_POLIWHIRL]  = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_POLIWRATH},
                            ...
                            {EVO_FRIENDSHIP, 0, SPECIES_POLITOED}}, // friendship
    [SPECIES_ABRA]       = {{EVO_LEVEL, 16, SPECIES_KADABRA}},
    [SPECIES_KADABRA]    = {{EVO_TRADE, 0, SPECIES_ALAKAZAM},
                            {EVO_SURVIVOR, 21, SPECIES_ALAKAZAM},
                            {EVO_LEVEL, 39, SPECIES_ALAKAZAM}},  // level / survivor
    [SPECIES_MACHOP]     = {{EVO_LEVEL, 28, SPECIES_MACHOKE}},
    [SPECIES_MACHOKE]    = {{EVO_TRADE, 0, SPECIES_MACHAMP},
                            {EVO_REVENGE, 0, SPECIES_MACHAMP},
                            {EVO_LEVEL, 41, SPECIES_MACHAMP}},   // level / revenge
    ...
    [SPECIES_GRAVELER]   = {{EVO_TRADE, 0, SPECIES_GOLEM},
                            {EVO_SURVIVOR, 30, SPECIES_GOLEM},
                            {EVO_REVENGE, 0, SPECIES_GOLEM}},     // survivor / revenge
    ...
    [SPECIES_SLOWPOKE]   = {{EVO_LEVEL, 37, SPECIES_SLOWBRO},
                            ...
                            {EVO_TRADE_ITEM, ITEM_KINGS_ROCK, SPECIES_SLOWKING}},   // water stone
    ...
    [SPECIES_HAUNTER]    = {{EVO_TRADE, 0, SPECIES_GENGAR},
                            ...
                            {EVO_REVENGE, 0, SPECIES_GENGAR}},                        // revenge / EVO_FRIENDSHIP_NIGHT
    [SPECIES_ONIX]       = {{EVO_TRADE_ITEM, ITEM_METAL_COAT, SPECIES_STEELIX},
                            {EVO_FRIENDSHIP_DAY, 0, SPECIES_STEELIX},
                            {EVO_SURVIVOR, 15, SPECIES_STEELIX},
                            {EVO_REVENGE, 0, SPECIES_STEELIX}},    // revenge / survivor / FRIENDSHIP_DAY
    ...
    [SPECIES_SEADRA]     = {{EVO_TRADE_ITEM, ITEM_DRAGON_SCALE, SPECIES_KINGDRA},
                            {EVO_FRIENDSHIP, 0, SPECIES_KINGDRA},
                            {EVO_SURVIVOR, 1, SPECIES_KINGDRA}},  // friendship / survivor
    ...
    [SPECIES_SCYTHER]    = {{EVO_TRADE_ITEM, ITEM_METAL_COAT, SPECIES_SCIZOR},
                            {EVO_SURVIVOR, 15, SPECIES_SCIZOR},
                            {EVO_REVENGE, 0, SPECIES_SCIZOR}},     // revenge / survivor
    ...
    [SPECIES_PORYGON]    = {{EVO_TRADE_ITEM, ITEM_UP_GRADE, SPECIES_PORYGON2},
                            {EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_PORYGON2},
                            {EVO_ITEM, ITEM_WATER_STONE, SPECIES_PORYGON2},
                            {EVO_ITEM, ITEM_FIRE_STONE, SPECIES_PORYGON2}},     // tripiedras?¿?¿?¿?
    ...
    [SPECIES_REMORAID]   = {{EVO_LEVEL, 25, SPECIES_OCTILLERY},
                            {EVO_SURVIVOR, 20, SPECIES_MANTINE}},
    ...
    [SPECIES_CLAMPERL]   = {{EVO_TRADE_ITEM, ITEM_DEEP_SEA_TOOTH, SPECIES_HUNTAIL}, // revenge / survivor 
                            {EVO_SURVIVOR, 20, SPECIES_HUNTAIL},
                            {EVO_REVENGE, 0, SPECIES_HUNTAIL},
                            {EVO_FRIENDSHIP, 0, SPECIES_GOREBYSS},     
                            {EVO_TRADE_ITEM, ITEM_DEEP_SEA_SCALE, SPECIES_GOREBYSS}},   // friendship 
