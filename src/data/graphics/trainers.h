...
const u32 gTrainerFrontPic_Noge[] = INCBIN_U32("graphics/trainers/front_pics/noge_front_pic.4bpp.lz");
const u32 gTrainerPalette_Noge[] = INCBIN_U32("graphics/trainers/palettes/noge.gbapal.lz");
...
const u8 gTrainerBackPic_Noge[] = INCBIN_U8("graphics/trainers/back_pics/ruby_sapphire_brendan_back_pic.4bpp");
