...
static const u8 sText_TooEasyNoExp[] = _("{B_BUFF1} needs a better\nchallenge to win EXP. Points.\p");
...
static const u8 sText_PlayerWhiteout[] = _("All of {B_PLAYER_NAME}'s POKéMON\nare dead.\p");
static const u8 sText_PlayerWhiteout2[] = _("GAME OVER{PAUSE_UNTIL_PRESS}");
...
const u8 * const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_TOOEASYNOEXP - 12] = sText_TooEasyNoExp,
};
