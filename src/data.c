...
const struct SpriteFrameImage gTrainerBackPicTable_Noge[] =
{
    gTrainerBackPic_Noge, 0x0800,
    gTrainerBackPic_Noge + 0x0800, 0x0800,
    gTrainerBackPic_Noge + 0x1000, 0x0800,
    gTrainerBackPic_Noge + 0x1800, 0x0800,
};
